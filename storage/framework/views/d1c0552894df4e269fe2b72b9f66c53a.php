    ...
    <?php if(auth()->guard()->check()): ?>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-secondary-500 h-fit sticky top-24">
                ...
                <form action="<?php echo e(route('reservations.store')); ?>" method="POST" class="space-y-5">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="reservation_date" value="<?php echo e(old('reservation_date', date('Y-m-d'))); ?>"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="col-span-1 sm:border-r border-gray-100 sm:pr-2">
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Hora
                                Inicio</label>
                            <div class="relative">
                                <input type="text" name="time_start" value="<?php echo e(old('time_start')); ?>"
                        ...
                        <div class="col-span-1 sm:pl-2 mt-4 sm:mt-0">
                            ...
                            <div class="relative">
                                <input type="text" name="time_end" value="<?php echo e(old('time_end')); ?>"
                                    class="timepicker w-full py-2 border-0 border-b-2 border-slate-200 focus:border-secondary-500 focus:ring-0 px-0 transition-colors bg-transparent text-sm font-medium text-gray-900 placeholder-gray-400"
                                    placeholder="Seleccionar hora..." required>
                                <div
                                    class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none text-gray-400">
                    ...
                    <div>
                        ...
                        <input type="number" name="attendees" min="1" value="<?php echo e(old('attendees', 1)); ?>"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const existingReservations = <?php echo json_encode($reservations, 15, 512) ?>;
                        ...
                        <?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                ...
                                color: '<?php echo e($reservation->status == "confirmed" ? "#10b981" : ($reservation->status == "cancelled" ? "#ef4444" : "#f59e0b")); ?>', 
                                extendedProps: {
